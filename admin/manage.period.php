...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../common/assets/plugins/datepicker/datepicker.css">
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading"><i class="glyphicon glyphicon-user fa-fw"></i> งวดหวย</div>
                            <div class="panel-body">
                                <div id="display-table-period-list">กำลังโหลดข้อมูล</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="../common/assets/plugins/datepicker/moment.min.js"></script>
    <script type="text/javascript" src="../common/assets/plugins/datepicker/datepicker.js"></script>
    ...
    <script type="text/javascript" src="assets/js/manage.period.js"></script>
</body>
</html>
<?php
        $Layout->MainModal('งวดหวย');
        $Layout->StatusModal();
    }
}
?>