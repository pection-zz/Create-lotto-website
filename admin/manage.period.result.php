...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="panel panel-success">
                            <div class="panel-heading"><i class="glyphicon glyphicon-user fa-fw"></i> ผลการออกรางวัล</div>
    ...
    <script type="text/javascript" src="assets/js/manage.period.result.js"></script>
</body>
</html>
<?php
        $Layout->MainModal('ผลการออกรางวัล');
        $Layout->StatusModal();
    }
}
?>