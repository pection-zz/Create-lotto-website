...
if(isset($Conn) && $Conn !== false){
	...
	if($Security->Authorize($Conn) == true){
        $sql = "SELECT * FROM ".TABLE_ADMINISTRATOR." WHERE AdminID = '".$_SESSION['AdminID']."' AND Password = '".md5($_POST['CurrentPassword'])."' LIMIT 1";
        ...
        if($result->rowCount() != 1){
            ...
            if(md5($_POST['NewPassword1']) != md5($_POST['NewPassword2'])){
                ...
                if($_POST['NewPassword1'] == '' || $_POST['NewPassword2'] == ''){
                    ...
                    $sql = "UPDATE ".TABLE_ADMINISTRATOR." SET Password = '".md5($_POST['NewPassword1'])."' WHERE AdminID = '".$_SESSION['AdminID']."' LIMIT 1";
                    $result = $Conn->prepare($sql);
                    $result->execute();
